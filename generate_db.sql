...
-- -----------------------------------------------------
-- Table `tennis_tournament`.`notifications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tennis_tournament`.`notifications` ;

CREATE TABLE IF NOT EXISTS `tennis_tournament`.`notifications` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tennis_tournament`.`tournament_registrations` (
  ...
  `status` ENUM('APPROVED', 'PENDING', 'REJECTED', 'WAITLISTED') NOT NULL,
